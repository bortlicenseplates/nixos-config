...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "James"
    user-mail-address "jamesryan864@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jamesryan/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jamesryan/bin" "/profile/bin" "/Users/jamesryan/.npm-packages/bin" "/Users/jamesryan/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
